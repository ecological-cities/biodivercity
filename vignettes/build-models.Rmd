...
As before, bird and landscape data at sampling points across six areas (towns) in Singapore will be used in this example. The example dataset, `beta_model_data`, contains both animal and landscape datasets processed in the previous two articles. The variable selection output using random forest is also loaded from `beta_model_variables`.
...
Calculate the average probability of each species occurring across all points. This is a required model input for the predictive _Beta_-diversity model.
