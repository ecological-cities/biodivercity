...
To include:
- Function for sampling point generation

## Quick subset of fauna survey data

The `filter_obs` function allows for the quick subsetting of fauna survey data and metadata that follows the following formats:
...
```{r filter_obs sample, eval = FALSE}
...
For example, a specific set of surveys (i.e. butterfly surveys in Tampines from 2020-2021) can be filtered as follows:
...
```{r filter_obs, eval = FALSE, echo = FALSE, message = FALSE}
