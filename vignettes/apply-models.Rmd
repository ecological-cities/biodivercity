...
By following this vignette, users will be able to predict (using a user-provided model object) animal species richness across a target landscape, and eventually visualise the prediction using a heatmap. Begin by loading the required libraries and data files:
...
```{r load bound geojson, eval=FALSE}
...
For interested readers, a breakdown of the `heatmap_raster` function is as follows (half a mind to remove this part):
