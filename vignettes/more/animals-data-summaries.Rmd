...
Load the example data. Refer to `help(animal_observations)` and `help(animal_surveys)` for more details on these datasets, as well as `vignette("process-animal")` on how the animal surveys were processed.
