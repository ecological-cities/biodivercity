...
**Take note**: `random_pt_gen` uses `st_read`, throwing an error when example data is used as it's meant to read shapefiles from local directories.
...
**Take note**: If species lists are not generated with this package, `Forest` plant survey methodology should be removed.
